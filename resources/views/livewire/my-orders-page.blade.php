                            ...
                            @foreach ($orders as $order)
                                @php
                                    ...
                                    if ($order->status == 'new') {
                                        ...
                                        $status = '<span class="bg-yellow-500 py-1 px-3 rounded text-white shadow">Delivered</span>';
                                    } elseif ($order->status == 'cancelled') {
                                        $status = '<span class="bg-red-800 py-1 px-3 rounded text-white shadow">Cancelled</span>';
                                    }
                                @endphp
