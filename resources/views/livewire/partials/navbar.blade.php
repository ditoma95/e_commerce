    ...
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Main navigation">
      <div class="relative md:flex md:items-center md:justify-between">
        ...
        <div id="navbar-collapse-with-animation"
          ...
          <div
            class="overflow-hidden overflow-y-auto max-h-[75vh] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-slate-500 dark:scrollbar-track-slate-700">
            <div
              ...
              <a wire:navigate
                class="{{ request()->is('/') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400' }} font-medium py-3 md:py-6 hover:text-gray-400 dark:hover:text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-600"
                href="/" aria-current="page">
                Home
              </a>

              <a wire:navigate
                class="{{ request()->is('/products') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400' }} font-medium hover:text-gray-400 py-3 md:py-6 dark:hover:text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-600"
                href="/products">
                Products
              </a>

              <a wire:navigate
                class="font-medium flex items-center {{ request()->is('/cart') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400' }} hover:text-gray-400 py-3 md:py-6 dark:hover:text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-600"
                href="/cart" aria-label="Shopping cart">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  stroke="currentColor" class="flex-shrink-0 w-5 h-5 mr-1" aria-hidden="true">
